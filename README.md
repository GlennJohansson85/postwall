...
&nbsp;&nbsp;&nbsp;&nbsp;**a) As a "Returning User",** I want to register to the site.
&nbsp;&nbsp;&nbsp;&nbsp;**a) As a "Returning User",** I want to post.

### 1.1.3 Frequent User Goals:
&nbsp;&nbsp;&nbsp;&nbsp;**a) As a "Frequent User",** I want to share my views/comment on others' content.
&nbsp;&nbsp;&nbsp;&nbsp;**a) As a "Frequent User",** I want to have the freedom to delete or edit my comments as well.
&nbsp;&nbsp;&nbsp;&nbsp;**a) As a "Frequent User",** I want to see content in a larger scale.
