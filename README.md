...
### 6.2.1 TEST - As a first-time visitor, I want to quickly understand the purpose of the website.
#### 6.2.1.1 A - The website name gives a smal hint of its purpose.
#### 6.2.1.1 B - The landing page, homepage, is where all posts are located. By browsing the posts and navigating through the navbar the user gets a clear message of the websites purpose.

### 6.2.1 TEST - As a first-time visitor, .
  * 
#### 6.2.1.1 Is the website´s purpose clear for first time visitors?
