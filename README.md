<h1>Postwall</h1>
<a href="https://postwall-500ee4318184.herokuapp.com/">See Live Project Here!</a><br>
...
### 6.2.1.3 TEST - As a first-time user, Browse Posts.
...
### 6.2.2.3 TEST - As a returning user, I want to Post.
...
### 6.2.3 Frequent User Goals
### 6.2.3.1 As a frequent user, i want to share my views/comment on others content
...
### 6.2.3.2 As a frequent user, i want to have the freedom to regret them aswell:
...
### 6.2.3.3 As a frequent user, i want to see content in a larger scale:
